...
const Dashboard = () => {
  ...
  const Sidebar_Links = [
    { id: 1, path: '/Mangement-Login/Dashboard/overview', name: "Overview", icon: MdDashboard },
    { id: 2, path: '/Mangement-Login/Dashboard/patients', name: "Patients", icon: IoPeople },
    { id: 3, path: '/Mangement-Login/Dashboard/doctors', name: "Doctors & Staff", icon: FaUserDoctor },
    { id: 4, path: '/Mangement-Login/Dashboard/inventory', name: "Inventory", icon: MdInventory2 },
  ];
